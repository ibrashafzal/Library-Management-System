...
namespace LMS.Reports
{
    ...
    {
        public static void ExportStudentToPDF(List<Student> students,string pdfPath,string reportTittle,DateTime startDate,DateTime endDate,float[] columnWidths = null,string logoPath = null)
        {
            ...
            try
            {
                ...
                headerTable.AddCell(new PdfPCell(new Phrase(reportTittle, titleFont))
                {
                    Border = Rectangle.NO_BORDER,
                    VerticalAlignment = Element.ALIGN_MIDDLE,
                ...
                // Headers
                string[] headers = { "ID", "Name", "Class", "Contact" };
                ...
                {
                    table.AddCell(new Phrase(student.Id.ToString(), FontFactory.GetFont(FontFactory.HELVETICA, 9)));
                    table.AddCell(new Phrase(student.Name, FontFactory.GetFont(FontFactory.HELVETICA, 9)));
                    table.AddCell(new Phrase(student.Class, FontFactory.GetFont(FontFactory.HELVETICA, 9)));
                    table.AddCell(new Phrase(student.Contact.ToString(), FontFactory.GetFont(FontFactory.HELVETICA, 9)));
